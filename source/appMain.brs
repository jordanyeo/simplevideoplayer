...
Sub Main(args As Dynamic)
    ...
    itemVenter = { ContentType:"episode"
               SDPosterUrl:"file://pkg:/images/zbcc.gif"
               HDPosterUrl:"file://pkg:/images/zbcc.gif"
               IsHD:True
               HDBranded:False
               ShortDescriptionLine1:"Live video feed of Zion Baptist Community Church"
               ShortDescriptionLine2:""
               Description:"A live video feed of the Zion Baptist Community Church sanctuary. The livestream computer and video camera must be turned on for this feed to work. For support, contact Jordan Yeo (780.902.7974)"
               Rating:"NR"
               StarRating:"100"
               Length:1
               Categories:["Zion Baptist Community Church"]
               Title:"Live video feed of Zion Baptist Community Church"
               }
...
Function displayVideo(args As Dynamic)
    ...
    urls = ["http://192.168.1.244/video/play.m3u8"]
    qualities = ["HD"]
    streamformat = "hls"
    title = "ZBCC"
    srt = ""
